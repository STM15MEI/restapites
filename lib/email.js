    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs Xyroinee</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285760451683">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>Xyroinee</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"ZXcoderID" <admin@xyroinee.xyz>',
        to: email,
        subject: 'Verify Email - Api ZXcoderID',
        html: inboxGmail,
      };
